...
_LANGUAGES: dict[str, tuple[str, tuple[tuple[str, float], ...]]] = {
    "en": (
        ...
        (
            ...
            (r"\bCOMPANY\s+STATUS\s+REPORT\b", 3.0),
            (r"\bSTATUS\s+REPORT\b", 2.5),
            (r"\bPERSONS?\s+WITH\s+SIGNIFICANT\s+CONTROL\b", 2.0),
            (r"\bPERSONSWITHSIGNIFICANTCONTROL\b", 2.0),
            (r"\bROLE\s+TYPE\s+DIRECTOR\b", 2.0),
            (r"\bDIRECTOR'?S?\s*DETAILS\b", 1.5),
            (r"\b(?:GENERAL|COMPANY|REGISTRATION)\s+DETAILS\b", 1.5),
